...
def get_add_objs(objname):
    ...
    if objname == 'Flask':
        add_objs = ['GlassBeaker', 'GraduatedCylinder', 'Pipette', 'TestTube', 'TuberackThin', 'TuberackWide'] # eggbox
    elif objname == 'GlassBeaker':
        add_objs = ['Flask', 'GraduatedCylinder', 'Pipette', 'TestTube', 'TuberackThin', 'TuberackWide']
    elif objname == 'GraduatedCylinder':
        add_objs = ['Flask', 'GlassBeaker', 'Pipette', 'TestTube', 'TuberackThin', 'TuberackWide']
    elif objname == 'Pipette':
        add_objs = ['Flask', 'GlassBeaker', 'GraduatedCylinder', 'TestTube', 'TuberackThin', 'TuberackWide']
    elif objname == 'TestTube':
        add_objs = ['Flask', 'GlassBeaker', 'GraduatedCylinder', 'Pipette', 'TuberackThin', 'TuberackWide']
    elif objname == 'TuberackThin':
        add_objs = ['Flask', 'GlassBeaker', 'GraduatedCylinder', 'Pipette', 'TestTube', 'TuberackWide']
    elif objname == 'TuberackWide':
        add_objs = ['Flask', 'GlassBeaker', 'GraduatedCylinder', 'Pipette', 'TestTube', 'TuberackThin']
    # elif objname == 'eggbox':
