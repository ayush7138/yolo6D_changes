...
def test(niter):
    ...
    datacfg = 'cfg/Flask_occlusion.data'
    logging("Testing Flask...")
    eval(niter, datacfg)
    datacfg = 'cfg/GlassBeaker_occlusion.data'
    logging("Testing GlassBeaker...")
    eval(niter, datacfg)
    datacfg = 'cfg/GraduatedCylinder_occlusion.data'
    logging("Testing GraduatedCylinder...")
    eval(niter, datacfg)
    datacfg = 'cfg/Pipette_occlusion.data'
    logging("Testing Pipette...")
    eval(niter, datacfg)
    datacfg = 'cfg/TestTube_occlusion.data'
    logging("Testing TestTube...")
    eval(niter, datacfg)
    datacfg = 'cfg/TuberackThin_occlusion.data'
    logging("Testing TuberackThin...")
    eval(niter, datacfg)
    datacfg = 'cfg/TuberackWide_occlusion.data'
    logging("Testing TuberackWide...")
    eval(niter, datacfg)
